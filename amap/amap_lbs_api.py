...
class amapApi:
    ...
    def __init__(self):
        ...
        self.__ak = 'om0hYFoR5AtNuyB2Ixy9ZxpzBN9h5qrZ'
        # SK
        self.__sk = '1FqrZvwxshXw0qTjhvvHZKlTuv0a5KgX'
        # 打开数据库连接
        self.__conn = pymysql.connect("192.168.0.106", "root", "123", "amap_lbs")
    ...
    def get_poi(self, keywords, city, types):
        ...
        if data['count'] != '0':
            params = []
            # 打开数据库连接
            db = pymysql.connect("192.168.0.106", "root", "123", "amap_lbs")
